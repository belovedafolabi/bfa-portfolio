    ...
    <section className="space-y-6">
      ...
      <div className="space-y-4">
        {posts.map((post, index) => (
          <Card
            key={index}
            className="bg-zinc-800/50 backdrop-blur-sm border-rounded hover:border-amber-400/50 hover:shadow-amber transition-all duration-300"
          >
            ...
            <CardContent>
              <p className="text-zinc-300 text-xs font-normal leading-relaxed">{post.excerpt}</p>
